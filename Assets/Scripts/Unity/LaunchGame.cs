...
namespace DefaultNamespace {
    public class LaunchGame : MonoBehaviour {
        ...
        private static void RunGame() {
			...
			Debug.Log(Vectorier.Settings.UseShortcutLaunch);

            if (Vectorier.Settings.UseShortcutLaunch) {
                gameExecutablePath = Vectorier.Settings.GameShortcutPath ?? SteamRunGamePath;
            } else {
                gameExecutablePath = Path.Combine(Vectorier.Settings.GameDirectory, "Vector.exe") ?? SteamRunGamePath;
            }
            ...
            try {
                var gameProcess = new Process {
                    StartInfo = {
						...
						WorkingDirectory = Vectorier.Settings.GameDirectory
                    },
